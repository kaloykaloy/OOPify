...
public class LevLes10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lev_les10);
        hideSystemUI();
        ...
        SessionManager sessionManager = new SessionManager(LevLes10.this);
        String tupId = sessionManager.getTupId();
        DatabaseHelper DB = new DatabaseHelper(LevLes10.this);
        ...
        proceedBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    case "1": {
                        Intent intent = new Intent(LevLes10.this, Maps.class);
        ...
        proceedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    ...
                    case "3": {
                        Intent intent = new Intent(LevLes10.this, LevProb10.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.enteranim, R.anim.exitanim);
                        break;
                    }
