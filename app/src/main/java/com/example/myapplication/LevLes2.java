...
public class LevLes2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lev_les2);
        hideSystemUI();
        ...
        SessionManager sessionManager = new SessionManager(LevLes2.this);
        String tupId = sessionManager.getTupId();
        DatabaseHelper DB = new DatabaseHelper(LevLes2.this);
        ...
        proceedBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    case "1": {
                        Intent intent = new Intent(LevLes2.this, Maps.class);
        ...
        proceedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    ...
                    case "3": {
                        Intent intent = new Intent(LevLes2.this, LevProb2.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.enteranim, R.anim.exitanim);
                        break;
                    }
