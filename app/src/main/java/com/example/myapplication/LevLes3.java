...
public class LevLes3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lev_les3);
        hideSystemUI();
        ...
        SessionManager sessionManager = new SessionManager(LevLes3.this);
        String tupId = sessionManager.getTupId();
        DatabaseHelper DB = new DatabaseHelper(LevLes3.this);
        ...
        proceedBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    case "1": {
                        Intent intent = new Intent(LevLes3.this, Maps.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.enteranim, R.anim.exitanim);
                        break;
                    }
                    case "2": {
                        instructionValue.setText("Encapsulation in C# Object-Oriented Programming (OOP) is the concept of bundling the data (fields) and the methods (functions) that operate on the data into a single unit, known as a class. It restricts direct access to some of an object's components and provides controlled ways to access and modify them. This helps protect the integrity of the data by preventing unauthorized or unintended interference.");
                        receivedLevel = "1";
                        break;
                    }
                    case "3": {
                        instructionValue.setText("Encapsulation hides the internal state of an object from the outside world and only exposes a controlled interface. Fields (variables) are typically made private to prevent direct access from outside the class. Public methods (getters and setters) or properties are used to provide controlled access to these private fields.");
                        receivedLevel = "2";
        ...
        proceedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    ...
                    case "2": {
                        instructionValue.setText("Using these modifiers helps in defining the scope and accessibility of class members, enhancing security and reducing the likelihood of misuse. C# provides several access modifiers to control the visibility of class members: private, protected, public, internal, protected internal.");
                        proceedButton.setImageResource(R.drawable.proceed_button);
                        receivedLevel = "3";
                        break;
                    }
                    case "3": {
                        Intent intent = new Intent(LevLes3.this, LevProb3.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.enteranim, R.anim.exitanim);
                        break;
                    }
