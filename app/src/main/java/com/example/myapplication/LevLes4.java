...
public class LevLes4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lev_les4);
        hideSystemUI();
        ...
        SessionManager sessionManager = new SessionManager(LevLes4.this);
        String tupId = sessionManager.getTupId();
        DatabaseHelper DB = new DatabaseHelper(LevLes4.this);
        ...
        proceedBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    case "1": {
                        Intent intent = new Intent(LevLes4.this, Maps.class);
        ...
        proceedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    ...
                    case "3": {
                        Intent intent = new Intent(LevLes4.this, LevProb4.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.enteranim, R.anim.exitanim);
                        break;
                    }
