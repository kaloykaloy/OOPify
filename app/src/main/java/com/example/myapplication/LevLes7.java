...
public class LevLes7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lev_les7);
        hideSystemUI();
        ...
        SessionManager sessionManager = new SessionManager(LevLes7.this);
        String tupId = sessionManager.getTupId();
        DatabaseHelper DB = new DatabaseHelper(LevLes7.this);
        ...
        proceedBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    case "1": {
                        Intent intent = new Intent(LevLes7.this, Maps.class);
        ...
        proceedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (receivedLevel) {
                    ...
                    case "3": {
                        Intent intent = new Intent(LevLes7.this, LevProb7.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.enteranim, R.anim.exitanim);
                        break;
                    }
